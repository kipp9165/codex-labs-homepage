...
const DEFAULT_WHALE_ACTIVATION_CUSTOMER_ID = "cus_UEciuOhA0I6mKl";
...
const config = {
  ...
  whaleActivationCustomerId: process.env.WHALE_ACTIVATION_CUSTOMER_ID || DEFAULT_WHALE_ACTIVATION_CUSTOMER_ID,
...
export {
  ...
  DEFAULT_WHALE_ACTIVATION_CUSTOMER_ID,
  config,
};
